...
class _SalesAnalyticsScreenState extends State<SalesAnalyticsScreen> {
  ...
  Future<void> loadData() async {
    final result = await AnalyticsService.getSalesAnalytics(Session.userId!);
  ...
  // "This Week" data-a naal (Mon-Sun) vachu group pannurom, chart-ku
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: Colors.green.withOpacity(0.3), blurRadius: 14, offset: const Offset(0, 6)),
                      ],
                    ),
                    child: Column(
                      children: [
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: value > 0 ? const Color(0xFF2E7D32) : Colors.grey.shade200,
  ...
  Widget _saleTile({required dynamic image, required String title, required String subtitle, required dynamic amount}) {
